...
# -*- coding: utf-8 -*-
"""
Created on Fri Jul 16 11:57:46 2021
...
nc_test = get_data(start_date = (2018, 7, 29), stop_date = (2018, 8, 2),
                    folder = "/Scratch/sturmpo/projects/LOTOS-EUROS-CONTROL/jul/output",
                    file_prefix = "/LE_jul_conc-sfc_")
...
nc_met_test = get_data(start_date = (2018, 7, 29), stop_date = (2018, 8, 2),
                        folder = "/Scratch/sturmpo/projects/LOTOS-EUROS-CONTROL/jul/output",
                        file_prefix = "/LE_jul_meteo-sfc_")
...
plot_TOA(single_column.average_TOA_test,single_column.average_TOA_NMF_test,date=' July 29- August 1, 2018')

# # make sure you are in some local directory Code to access lotos-euros/v2.2/proj/vbs-ML/001/data
# folder_TOM = "lotos-euros/v2.2/proj/vbs-ML/001/data/superspecies_matrices/summer/"
