...
contains
  ...
  subroutine LE_VBS_ML_Init( status )
    ...
    character(len = 250)												::	path = '/tsn.tno.nl/Data/SV/sv-059025_unix/ProjectData/VBS-machinelearning/users/Obin/Code/lotos-euros/v2.2/proj/vbs-ML/001/data/superspecies_matrices/winter/' 
