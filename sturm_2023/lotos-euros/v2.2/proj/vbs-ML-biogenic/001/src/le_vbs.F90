...
contains
  ...
  subroutine LE_VBS_ML_Init( status )
    ...
    ! superspecies optimized on summer conditions
    !character(len = 250)												::	path = '/tsn.tno.nl/Data/SV/sv-059025_unix/ProjectData/VBS-machinelearning/users/Obin/Code/lotos-euros/v2.2/proj/vbs-ML/001/data/superspecies_matrices/summer/' 
    
    ! superspecies optimized on winter conditions
    character(len = 250)												::	path = '/tsn.tno.nl/Data/SV/sv-059025_unix/ProjectData/VBS-machinelearning/users/Obin/Code/lotos-euros/v2.2/proj/vbs-ML-biogenic/001/data/superspecies_matrices/winter/' 
    
    ! composition matrices optimized on winter conditions, scaling factor for compression/decompression not needed
    !character(len = 250)												::	path = '/tsn.tno.nl/Data/SV/sv-059025_unix/ProjectData/VBS-machinelearning/users/Obin/Code/lotos-euros/v2.2/proj/vbs-ML/001/data/superspecies_matrices/winter_composition_matrices/' 
    
    ! summer optimized superspecies, top 4 bins biogenic VBS used in training
    !character(len = 250)												::	path = '/tsn.tno.nl/Data/SV/sv-059025_unix/ProjectData/VBS-machinelearning/users/Obin/Code/lotos-euros/v2.2/proj/vbs-ML/001/data/superspecies_matrices/summer_4binbiogenic/' 
    ...
    do while (status == 0)
      ...
      print *, "loaded in machine learning matrices for superspecies"
      do i = 1,2
        !print *,"example compression matrix, bsog row",i,": ", (compress_bsog(i,j), j = 1,n_vbs_bsog)
      enddo
