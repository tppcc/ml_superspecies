module Binas
  ...
  ! kappa
  real, parameter                  ::  kappa_stab = 0.35
  
  ! prandtl number
  real, parameter                  ::  pr_t = 0.74
  
  ! mass function stable
  real, parameter                  ::  beta_m = 4.7
  
  ! mass function unstable   
  real, parameter                  ::  gamma_m = 15.0
  
  ! heat function stable 
  real, parameter                  ::  beta_h = 4.7
  
  ! heat function unstable  
  real, parameter                  ::  gamma_h = 9.0
