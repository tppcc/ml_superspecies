...
!
!   C3PO_File_Rgg  : access files with data defined or reduced-gaussian-grid
!
! EXAMPLE
!
...
module C3PO_File_Rgg
  ...
  contains
#ifdef without_f2003
    procedure   ::  Open                    => File_Rgg_Open
    procedure   ::  Create                  => File_Rgg_Create
    procedure   ::  EndDef                  => File_Rgg_EndDef
    procedure   ::  Close                   => File_Rgg_Close
    procedure   ::  Inquire                 => File_Rgg_Inquire
    procedure   ::  Inquire_Dimension       => File_Rgg_Inquire_Dimension
    procedure   ::  Copy_Dimension          => File_Rgg_Copy_Dimension
    procedure   ::  Inquire_Variable        => File_Rgg_Inquire_Variable
    procedure   ::  Define_Variable_Copy    => File_Rgg_Define_Variable_Copy
    procedure   ::  Copy_Atts               => File_Rgg_Copy_Atts
    procedure   ::  Extend_History          => File_Rgg_Extend_History
#endif
...
contains
  ...
  subroutine File_Rgg_Open( self, filename, status )
    ...
    XTYPE(T_File_Rgg), intent(out)   ::  self
    character(len=*), intent(in)    ::  filename
    integer, intent(out)            ::  status

    ! --- const --------------------------------------

    character(len=*), parameter  ::  rname = mname//'/File_Rgg_Open'
  ...
  end subroutine File_Rgg_Open


  ! ***


  subroutine File_Rgg_Create( self, filename, status, formatNum )
    ...
    character(len=*), parameter  ::  rname = mname//'/File_Rgg_Create'
  ...
  end subroutine File_Rgg_Create


  ! ***
  
  
  subroutine File_Rgg_EndDef( self, status )

    use NetCDF, only : NF90_EndDef
  
    ! --- in/out ---------------------------------
    
    XTYPE(T_File_Rgg), intent(inout) ::  self
    integer, intent(out)            ::  status

    ! --- const --------------------------------------

    character(len=*), parameter  ::  rname = mname//'/File_Rgg_EndDef'
  ...
  end subroutine File_Rgg_EndDef


  ! ***
  
  
  subroutine File_Rgg_Close( self, status )
    ...
    character(len=*), parameter  ::  rname = mname//'/File_Rgg_Close'
  ...
  end subroutine File_Rgg_Close


  ! ***
  
  
  subroutine File_Rgg_Inquire( self, status, ndim, nvar )

    use NetCDF, only : NF90_Inquire
  
    ! --- in/out ---------------------------------
    
    XTYPE(T_File_Rgg), intent(in)    ::  self
    integer, intent(out)            ::  status
    ...
    character(len=*), parameter  ::  rname = mname//'/File_Rgg_Inquire'
  ...
  end subroutine File_Rgg_Inquire


  ! ***
  
  
  subroutine File_Rgg_Inquire_Dimension( self, idim, status, name )
    ...
    character(len=*), parameter  ::  rname = mname//'/File_Rgg_Inquire_Dimension'
  ...
  end subroutine File_Rgg_Inquire_Dimension


  ! ***
  
  
  subroutine File_Rgg_Copy_Dimension( self, dimname, outfile, status )
    ...
    character(len=*), parameter  ::  rname = mname//'/File_Rgg_Copy_Dimension'
  ...
  end subroutine File_Rgg_Copy_Dimension


  ! ***
  
  
  subroutine File_Rgg_Inquire_Variable( self, ivar, status, name )
    ...
    character(len=*), parameter  ::  rname = mname//'/File_Rgg_Inquire_Variable'
  ...
  end subroutine File_Rgg_Inquire_Variable


  ! ***
  
  
  subroutine File_Rgg_Define_Variable_Copy( self, varname, outfile, varid, status )
    ...
    character(len=*), parameter  ::  rname = mname//'/File_Rgg_Define_Variable_Copy'
  ...
  end subroutine File_Rgg_Define_Variable_Copy
  ...
  subroutine File_Rgg_Copy_Atts( self, varname, outfile, status )
    ...
    character(len=*), parameter  ::  rname = mname//'/File_Rgg_Copy_Atts'
  ...
  end subroutine File_Rgg_Copy_Atts
  ...
  subroutine File_Rgg_Extend_History( self, message, status )
    ...
    character(len=*), parameter  ::  rname = mname//'/File_Rgg_Extend_History'
  ...
  end subroutine File_Rgg_Extend_History
  ...
  subroutine File_Rgg_Get_Grid( self, rgg, status )
    ...
    XTYPE(T_File_Rgg), intent(in)       ::  self
    XTYPE(T_Grid_RGG), intent(out)      ::  rgg
    integer, intent(out)                ::  status
          ...
          case ( NF90_INT )
            ...
            if ( any(rgridim) ) then
              ...
              if ( rgridim(1) ) then
                ...
                ! not yet ...
                write (gol,'("unsupported rgrid dimensions : ",3l2)') rgridim(1:ndim); call goErr
                TRACEBACK; status=1; return
              end if
            else
              ! storage:
