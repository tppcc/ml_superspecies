  ...
  subroutine LE_CF_names( name, unit, &
    ...
    select case ( name )
      ...
      case ( 'vbs_cg1', 'vbs_cg2', 'vbs_cg3', &
        ...
        cf_units     = 'mole mole-1'
      case ( 'tpm10', 'tpm10_biascorr', 'tpm10_comb' )
        cf_type      = 'tracer'
        cf_spec_stnd = ''         ! not available yet ...
        cf_spec_long = 'TPM10'
        cf_units     = 'kg m-3'
      case ( 'tpm25', 'tpm25_biascorr', 'tpm25_comb' )
        cf_type      = 'tracer'
        cf_spec_stnd = ''         ! not available yet ...
        cf_spec_long = 'TPM25'
        cf_units     = 'kg m-3'
      ...
      case ( 'SIA25', 'sia25' )
        cf_type      = 'tracer'
        cf_spec_stnd = 'secondary_inorganic_aerosol <2.5um'
        cf_spec_long = 'SIA25'
        cf_units     = 'kg m-3'
      ...
      case( 'pol_r' )
        cf_type           = 'tracer'
        cf_standard_name  = 'Ragweed pollen'      
        cf_spec_stnd      = 'pol_r'
        cf_spec_long      = 'Ragweed pollen'
        cf_long_name      = 'Concentration in air RAGWEED POLLEN'
        cf_units          = '#/m3'
#endif        
      case default
