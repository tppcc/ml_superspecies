...
module Num_Random
  ...
  contains
    ...
    !
    procedure ::                    Random_Get_Normal_0d
    procedure ::                    Random_Get_Normal_1d
    generic   ::  Get_Normal    =>  Random_Get_Normal_0d, &
                                    Random_Get_Normal_1d
    !
  end type T_Random
...
contains
  ...
  subroutine Random_Get_Normal_0d( self, x, status, &
                                     mu, sigma )
    ...
    character(len=*), parameter   ::  rname = mname//'/Random_Get_Normal_0d'
  ...
  end subroutine Random_Get_Normal_0d
  
  ! *
  
  subroutine Random_Get_Normal_1d( self, x, status, &
                                     mu, sigma )
    ...
    character(len=*), parameter   ::  rname = mname//'/Random_Get_Normal_1d'
    ...
    do i = 1, size(x)
      ! draw random number:
      call self%Get_Normal( x(i), status, mu=mu, sigma=sigma )
      IF_NOTOK_RETURN(status=1)
    end do
  ...
  end subroutine Random_Get_Normal_1d
