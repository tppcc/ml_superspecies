      ...
      !~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
          ...
          do i = 1, nx
            ...
            do ispec = 1, nspec
              ...
              if ( cmean(ispec) > 0.0 ) then
                ...
                cosarg = cos(arg)
                ! fill:
                caloft(i,j,ispec) = ( cmean(ispec) + dc(ispec)*cosarg ) * exp(-hh/hz(ispec)) * latdep(ind,ispec)
              end if
            end do  ! ispec
          end do ! i
        ...
        do ispec=1,nspec
          ...
          if ( (ispec == i_so2) .or. (ispec == i_so4a_f) ) then
            ...
            caloft  (:,:, ispec) = caloft  (:,:,ispec)*SIAtrend%so2
            ...
            caloft  (:,:, ispec) = caloft  (:,:,ispec)*SIAtrend%nh4
            ...
            caloft  (:,:, ispec) = caloft  (:,:,ispec)*SIAtrend%nox
           ...
           !     caloft(:,:, ispec) = caloft(:,:,ispec)*trend_co
           ...
           !     caloft(:,:, ispec) = caloft(:,:,ispec)*trend_voc
          end if
        end do
        ...
        do ispec = 1, nspec
          ...
          if ( cmean(ispec) > 0.0 ) then
            ...
            where ( caloft  (:,:,ispec) < cmin(ispec) ) caloft  (:,:,ispec) = cmin(ispec)
            ! set flag:
