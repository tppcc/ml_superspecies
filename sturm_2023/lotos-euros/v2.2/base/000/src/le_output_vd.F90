...
contains
  ...
  subroutine LE_Output_vd_Init( leo, rcfile, rckey, typ, name, state, status )
    ...
    call SetDat( LE_Dat( 1), 'Ra'            , 's/m'                , 2, .false., .false., .true. )
    call SetDat( LE_Dat( 2), 'Rb'            , 's/m'                , 2, .false., .true. , .true. )
    call SetDat( LE_Dat( 3), 'Rc_eff'        , 's/m'                , 2, .false., .true. , .true. )
    call SetDat( LE_Dat( 4), 'vd'            , 'm/s'                , 2, .false., .true. , .true. )
    call SetDat( LE_Dat( 5), 'lufrac'        , '-'                  , 2, .true. , .false., .true. )
    call SetDat( LE_Dat( 6), 'fluxdry'       , 'umol m-2 s-1'       , 2, .false., .true. , .true. )
    call SetDat( LE_Dat( 7), 'fstom_o3_hr'   , 'umol m-2 s-1'       , 2, .false., .false., .true. )
    call SetDat( LE_Dat( 8), 'area'          , 'm2'                 , 2, .true. , .false., .false.)
    call SetDat( LE_Dat( 9), 'lai'           , 'm2 leaf m-2 surface', 2, .false., .false., .true. )
    call SetDat( LE_Dat(10), 'sai'           , 'm2 leaf m-2 surface', 2, .false., .false., .true. )
    call SetDat( LE_Dat(11), 'frac_sto_o3_lu', '-'                  , 2, .false., .false., .true. )
    call SetDat( LE_Dat(12), 'rbc_o3_lu'     , 's/m'                , 2, .false., .false., .true. )
    call SetDat( LE_Dat(13), 'czcanopytop_o3_lu', 'mol mol-1'       , 2, .false., .true. , .true. )
    call SetDat( LE_Dat(14), 'Cc_lu'         , 'ug m-3'             , 2, .false., .true. , .true. )
    call SetDat( LE_Dat(15), 'Fd_tot_lu'     , 'ug m-2 s-1'         , 2, .false., .true. , .true. )
    call SetDat( LE_Dat(16), 'Fd_sto_lu'     , 'ug m-2 s-1'         , 2, .false., .true. , .true. )
    call SetDat( LE_Dat(17), 'Fd_ext_lu'     , 'ug m-2 s-1'         , 2, .false., .true. , .true. )
    call SetDat( LE_Dat(18), 'Fd_soi_lu'     , 'ug m-2 s-1'         , 2, .false., .true. , .true. )
    call SetDat( LE_Dat(19), 'Cstom'         , 'ug m-3'             , 2, .false., .true. , .true. )
    call SetDat( LE_Dat(20), 'Cw'            , 'ug m-3'             , 2, .false., .true. , .true. )
    call SetDat( LE_Dat(21), 'Csoil'         , 'ug m-3'             , 2, .false., .true. , .true. )
    call SetDat( LE_Dat(22), 'gstom'         , 'm/s'                , 2, .false., .true. , .true. )
    call SetDat( LE_Dat(23), 'gw'            , 'm/s'                , 2, .false., .true. , .true. )
    call SetDat( LE_Dat(24), 'gsoil_eff'     , 'm/s'                , 2, .false., .true. , .true. )                         
    call SetDat( LE_Dat(25), 'Rs'            , 's/m'                , 2, .false., .true. , .true. )
    call SetDat( LE_Dat(26), 'vs'            , 'm/s'                , 2, .false., .true. , .false. )
    call SetDat( LE_Dat(27), 'ustar_lu'      , 'm/s'                , 2, .false., .false., .true. )
    
    ! variable names:
    call ReadRc( rcF, trim(basekey)//'.fields', selected_names, status )
    IF_NOTOK_RETURN(status=1)    
    ...
    ! tracer names:
    call ReadRc( rcF, trim(basekey)//'.tracers', selected_names, status )
    IF_NOTOK_RETURN(status=1)
    ! setup storage for tracer fields:
    ...
    ! landuse names:
    call ReadRc( rcF, trim(basekey)//'.landuses', selected_names, status )
    IF_NOTOK_RETURN(status=1)
    ! setup storage for tracer fields:
