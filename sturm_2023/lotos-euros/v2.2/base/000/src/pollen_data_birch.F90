...
contains
  ...
  subroutine Pollen_Data_Birch_Init( emb, rcF, rckey, t, status )
    ...
    ! input descriptions
    allocate( descriptionlist(4) )
    descriptionlist = (/'standard_name=Birch Percentage', 'standard_name=Heatsum_start', &
                        'standard_name=Heatsum_end', 'standard_name=Intensity of Pollen'/)
    ...
    !After the start of the season with or without restart file:
      ...
      ! there
        ...
        call LE_Restart_Restore( 'heatsum_pol', emb%heatsum, &
