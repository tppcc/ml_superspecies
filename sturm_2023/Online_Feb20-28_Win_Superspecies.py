...
# -*- coding: utf-8 -*-
"""
Created on Fri Aug 20 14:00:41 2021
...
plot_online_site(caba_lati, caba_long, "Cabauw MACC Grid", TOA, TOA_ML, timerange = "Feb 20-28")
plt.savefig('figs/cabauw_macc.pdf', format='pdf')
plot_online_site(mace_lati, mace_long, "Mace Head MACC Grid", TOA, TOA_ML, timerange = "Feb 20-28")
plt.savefig('figs/macehead_macc.pdf', format='pdf')

# take a look at error
plt.plot(np.linspace(0,9,216),np.mean(np.mean(TOA_ML,axis=3),axis=2),color = 'g')
plt.plot(np.linspace(0,9,216),np.mean(np.mean(TOA_ML,axis=3),axis=2),color = 'maroon')
