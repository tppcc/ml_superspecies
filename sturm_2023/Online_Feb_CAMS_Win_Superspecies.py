...
plt.savefig('figs/online_cams_winter_control.png', format='png', dpi=300)
...
plt.savefig('figs/online_cams_winter_superspecies.png', format='png', dpi=300)
...
plt.savefig('figs/online_cams_winter_winsup_bias.png', format='png', dpi=300)
...
plt.savefig('figs/online_cams_winter_winsup_relbias.png', format='png', dpi=300)
